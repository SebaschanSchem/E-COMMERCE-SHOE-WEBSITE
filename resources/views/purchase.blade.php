    ...
    <div class="p-8">
        ...
        <div class="grid grid-cols-2 gap-8">
            ...
            <!-- Product Image -->
<div class="bg-gray-200 h-[300px] flex items-center justify-center p-4">
    <img 
        src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQiabWsiBrKUNecgrx24xT6O957rXzPSlKJDA&s" 
