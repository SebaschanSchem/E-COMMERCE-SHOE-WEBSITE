...
<section class="bg-white py-14 px-6 text-white">

    <div class="max-w-6xl mx-auto">

        <h2 class="text-black text-3xl font-bold text-center mb-8 tracking-wide">TRENDING</h2>
        <br>

        <div class="grid md:grid-cols-2 gap-10 items-center">

            <div class="bg-white p-4 rounded-xl hover:scale-105 transition">
            ...
            <div>
                <h3 class="text-black text-2xl font-bold mb-4">NIKE SAPATOSAN</h3>
    ...
    <br>
    <h2 class="text-black text-3xl font-bold text-center mb-8 tracking-wide">LAYOUT</h2>
    <br>
    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div>
                <h3 class="text-black text-2xl font-bold mb-4">HOW IT MADE</h3>
    ...
    <h2 class=" text-black text-3xl font-bold mb-6 tracking-wide text-center">AVAILABLE IN:</h2>
...
<div class="flex justify-center items-center gap-16">
    ...
    <div class="flex flex-col items-center hover:scale-105 transition">
        ...
        <h3 class=" text-black mt-3 text-lg font-bold">ONLINE PLATFORM</h3>
    </div>

    <div class="flex flex-col items-center hover:scale-105 transition">
        <img src="{{ asset('img/store.png') }}" class="w-full h-auto object-contain rounded-[10px]">
        <h3 class=" text-black mt-3 text-lg font-bold">PHYSICAL STORES</h3>
    </div>
        ...
        <br>
        <h1 class="text-black text-2xl font-bold">FOLLOW US ON:</h1>
